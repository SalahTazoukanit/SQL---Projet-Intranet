...
<body>
    ...
    include "header.php"
    ?>
    <form  class="formulaireAddEdit" action="" method="POST">
    <div class="borderFormAdd">    
        <div class="colonneUn">
            ...
            <div>Lieu <br><input value="" name="lieuInput" type="text"></div>
            <div>Tarif <br><input name="tarifInput" type="text"></div>
        </div>
        <div class="colonneDeux">
            <div>Image <br><input name="imageVoyage" type="text"></div>
